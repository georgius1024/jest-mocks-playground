...
describe('Movies', () => {
  ...
  it('can create movies item', async () => {
    ...
    expect(axios.post).toHaveBeenCalledWith('localhost:4000/movies', {text: '123'})
  })
  ...
  it('can update movies item', async () => {
    ...
    expect(axios.put).toHaveBeenCalledWith('localhost:4000/movies/123', {text: '123'})
  })
  ...
  it('can destroy movies item', async () => {
    ...
    expect(axios['delete']).toHaveBeenCalledWith('localhost:4000/movies/123', null)
  })
})